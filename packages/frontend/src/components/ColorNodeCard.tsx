...
function PropertyControl({ label, prop, fullName, node, toggleLock, toggleDiff, hasPrevSelected, hasNextSelected }: PropertyControlProps) {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div 
          className="absolute bottom-full flex gap-0 items-center justify-center bg-[#252525] rounded-[5px] shadow-lg z-10"
        >
          <button
            onClick={(e) => {
              e.stopPropagation();
          ...
          <button
            ...
            className="w-6 h-6 rounded transition-colors flex items-center justify-center hover:bg-[#ffffff]/[0.06]"
            style={{
              color: node[`diff${prop}` as keyof ColorNode] === true ? '#465BFE' : '#a1a1a1'
            }}
            ...
            <span className="relative inline-block text-[12px]">
              ...
              {node[`diff${prop}` as keyof ColorNode] === false && (
                <span className="absolute inset-0 flex items-center justify-center text-[12px]">
                  <span className="w-full h-[1px] bg-[#a1a1a1] rotate-[-45deg] rounded-full" />
                </span>
              )}
            </span>
          </button>
...
function PropertyControls({ property, isDiffEnabled, isLocked, onToggleDiff, onToggleLock, hasParent, hideControls, disabled, diffValue, onDiffValueChange, precision = 0, isAdvancedActive = false }: PropertyControlsProps) {
  ...
  return (
    <div className={`flex items-center gap-1 ${disabled ? 'opacity-50' : ''}`}>
      ...
      <Label className={disabled ? 'text-[#ededed]/50' : 'text-[#ededed]'}>{property}</Label>
      {hasParent && !hideControls && !isAdvancedActive && (
            ...
            editingDiff ? (
              <input
                ...
                style={{
                  background: '#1a1a1a',
                  borderColor: '#465BFE',
                  color: isDiffEnabled ? '#465BFE' : '#666',
                }}
              />
            ) : (
              <button
    ...
    <div className="px-4 pb-4 space-y-3">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          >
            {node.paletteNameLocked ? (
              <Lock className="w-3.5 h-3.5 text-[#465BFE]" />
            ) : (
        ...
        <Input
          ...
          className="bg-[#1a1a1a] border-0 text-[#ededed]"
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <div 
            className="w-8 h-8 rounded-lg border border-[#1a1a1a]"
            style={{ 
        ...
        <div className="flex gap-2">
          <Select value={colorFormat} onValueChange={(value) => onUpdateNode(node.id, { paletteColorFormat: value as any })}>
            <SelectTrigger className="w-24 bg-[#1a1a1a] border-[#1a1a1a] text-[#ededed] h-9">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="bg-[#1a1a1a] border-[#1a1a1a]">
              <SelectItem value="HEX" className="text-[#ededed]">HEX</SelectItem>
              <SelectItem value="HSLA" className="text-[#ededed]">HSLA</SelectItem>
              <SelectItem value="OKLCH" className="text-[#ededed]">OKLCH</SelectItem>
              <SelectItem value="RGBA" className="text-[#ededed]">RGBA</SelectItem>
            </SelectContent>
          </Select>
          
          <div className="flex-1 bg-[#1a1a1a] border border-[#1a1a1a] rounded-lg px-3 py-2 text-[#ededed] text-sm font-mono">
      ...
      <div>
        ...
        <Select value={lightnessMode} onValueChange={(value) => onUpdateNode(node.id, { paletteLightnessMode: value as any })}>
          <SelectTrigger className="bg-[#1a1a1a] border-[#1a1a1a] text-[#ededed]">
            <SelectValue />
          </SelectTrigger>
          <SelectContent className="bg-[#1a1a1a] border-[#1a1a1a]">
            <SelectItem value="linear" className="text-[#ededed]">Linear</SelectItem>
            <SelectItem value="curve" className="text-[#ededed]">Curve</SelectItem>
          </SelectContent>
        </Select>
      </div>
        ...
        <div className="space-y-2">
          <div className="relative pt-2 pb-4">
            ...
            <div className="relative h-6 flex items-center">
              ...
              <div className="absolute w-full h-3 bg-[#1a1a1a] rounded-full"></div>
      ...
      <div>
        ...
        <Select value={namingPattern} onValueChange={(value) => onUpdateNode(node.id, { paletteNamingPattern: value as any })}>
          ...
          <SelectContent className="bg-[#1a1a1a] border-[#1a1a1a]">
            <SelectItem value="1-9" className="text-[#ededed]">1-9</SelectItem>
            <SelectItem value="10-90" className="text-[#ededed]">10-90</SelectItem>
            <SelectItem value="100-900" className="text-[#ededed]">100-900</SelectItem>
            <SelectItem value="a-z" className="text-[#ededed]">a-z</SelectItem>
          </SelectContent>
        </Select>
      </div>
      ...
      <div>
        <div className="flex justify-between items-center mb-1">
          ...
          <span className="text-[#ededed] text-sm">{shadeCount}</span>
        </div>
        <input
          type="range"
          min="2"
          ...
          className="w-full h-1 bg-[#252525] rounded-full appearance-none cursor-pointer palette-range-slider"
          onMouseDown={(e) => e.stopPropagation()}
        />
        <div className="flex justify-between mt-2">
          <span className="text-xs text-[#a1a1a1]">2</span>
          <span className="text-xs text-[#a1a1a1]">20</span>
        </div>
      </div>
    </div>
  );
        ...
        <div className="absolute -left-[5px] top-1/2 -translate-y-1/2 z-20" style={{ pointerEvents: 'auto' }}>
          <div
            className={`w-[8px] h-[8px] rounded-full ${
              isDraggingWire && wireStartButtonType === 'right' ? 'bg-[#2BBD68]' : 'bg-[#555]'
            }`}
  ...
  return (
    <div className="relative" data-node-card>
      ...
      {isPaletteShade && (
        ...
        >
          <div
            className="w-[10px] h-[10px] rounded-full bg-[#465BFE] flex items-center justify-center"
            title="Connected to palette"
            data-node-id={node.id}
            data-button-type="left-connect"
          />
      ...
      {(
        ...
        >
          ...
          {node.isPalette && (
            ...
            >
              <Plus className={`w-3 h-3 ${isColorInputDisabled ? 'text-[#555]' : (node.paletteShadeCount || 10) >= 20 ? 'text-white' : 'text-[#ededed]'}`} strokeWidth={3} />
            </button>
          )}
        </div>
      )}
    ...
    {showInheritanceIcon && !isPrimaryTheme && (
      ...
      >
          ...
          <span className={`text-[11px] select-none transition-colors ${
            isLinkedToPrimary() ? 'text-[#999]' : hasColorBeenModified ? 'text-[#999]' : 'text-[#666]'
          }`}>
            {isLinkedToPrimary() 
              ? 'Node is inherited' 
              : hasColorBeenModified 
    ...
    >
      ...
      >
        ...
        {showDevMode && !isPaletteShade && (
          <button
            className={`absolute top-2 right-2 z-10 flex items-center gap-1 h-5 px-1.5 rounded-md text-[9px] font-medium transition-all cursor-pointer ${
              node.isWebhookInput
                ? 'bg-[#FBBF24]/90 text-black shadow-md shadow-[#FBBF24]/30'
        ...
        {isPaletteShade && (
          <div
            className={`cursor-move absolute top-2 -left-[22px] text-[#a1a1a1] hover:text-[#ededed] transition-all ${
        ...
        <div className="absolute bottom-2 right-2 flex items-center gap-1">
          ...
          <Popover open={showColorPicker} onOpenChange={(open) => { if (!isColorInputDisabled) setShowColorPicker(open); }}>
            ...
            <PopoverContent 
              className="w-[268px] p-4 bg-[#161616] border-[#1a1a1a]"
              onClick={(e) => e.stopPropagation()}
              onMouseDown={(e) => e.stopPropagation()}
                    ...
                    {!isChannelHidden('oklchC') && (<div className="space-y-2">
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-[10px] text-[#888888]" title="Actual range: 0-0.4">(0-{((effectiveColors.oklchC || 0) / 100 * 0.4).toFixed(2)})</span>
                        </div>
                        <div className="flex items-center gap-1">
          ...
          {(() => {
            ...
            return (
              <div key={assignedTokenId} className="flex items-center gap-2">
                <div className="flex-1 flex items-center gap-2 h-8 px-3 rounded-[8px] bg-[#1a1a1a] text-[#ededed] min-w-0">
                  <Tag className="w-3 h-3 text-[#a1a1a1] shrink-0" />
                  <span className="truncate text-xs min-w-0">{assignedToken.name}</span>
                  {isAutoAssigned && (
                    <Zap className="w-3 h-3 text-[#465BFE] shrink-0 fill-current ml-auto" />
                  )}
                </div>
                {!readOnly && (
                ...
                <button
                  ...
                  className="p-1 hover:bg-[#ffffff]/[0.06] rounded transition-colors shrink-0"
                  onMouseDown={(e) => e.stopPropagation()}
                >
            ...
            <Popover open={tokenComboOpenIndex === -1} onOpenChange={(open) => setTokenComboOpenIndex(open ? -1 : null)}>
              <PopoverTrigger asChild>
                <Button
                  ...
                  className="flex-1 h-8 justify-between text-xs overflow-hidden bg-[#1a1a1a] border-[#1a1a1a] text-[#ededed] hover:bg-[#222] hover:text-[#ededed]"
                  onMouseDown={(e) => e.stopPropagation()}
                  onClick={() => onSelect()}
                >
                  <span className="text-[#888888]">Select token...</span>
                  <ChevronsUpDown className="h-4 w-4 shrink-0 opacity-50" />
                </Button>
              </PopoverTrigger>
                <PopoverContent 
                  className="w-[240px] p-0 bg-[#161616] border-[#1a1a1a]" 
                  side="bottom"
                  align="start"
                  onMouseDown={(e) => e.stopPropagation()}
                >
                  ...
                  {pages.length > 0 && (
                    <div className="px-1.5 pt-1.5">
                      <div className="flex items-center rounded-lg bg-[#0e0e0e] p-[3px]">
                        <span className="shrink-0 px-2 py-[3px] rounded-md text-[10px] bg-[#252525] text-[#ededed] shadow-sm">
                          This page
                        </span>
                      </div>
                    </div>
                  )}
                  <Command className="bg-[#161616]" filter={(value, search, keywords) => {
                                ...
                                >
                                  ...
                                  >
                                      <div className={cn(
                                        ...
                                        isCurrentlyAssigned 
                                          ? "bg-[#ffffff]/[0.06] ring-1 ring-[#ffffff]/[0.08]" 
                                          : isAlreadyAssigned && !isCurrentlyAssigned 
                                            ? cn(
                                                "ring-1",
                                                isReassignPopoverOpen
                                                  ? "bg-[#465BFE]/[0.22] ring-[#465BFE]/35"
                                                  : "bg-[#465BFE]/[0.12] ring-[#465BFE]/20 hover:bg-[#465BFE]/[0.20] hover:ring-[#465BFE]/30"
                                              )
                                            : "hover:bg-[#ffffff]/[0.05]"
                                      )}>
                                        <div
                                          className={cn("w-3.5 h-3.5 rounded-[3px] shrink-0", (!isAssignedToAnyNode || _isEmpty1) && "border border-dashed border-[#252525]/40 opacity-40")}
                                          style={{ backgroundColor: (isAssignedToAnyNode && !_isEmpty1) ? hslValue : 'transparent' }}
                                        />
                                        <div className="flex flex-col min-w-0 flex-1">
                                          <span className={cn("truncate transition-colors", isCurrentlyAssigned ? "text-[#ededed]" : isAlreadyAssigned ? "text-[#ededed]" : "text-[#ccc] group-hover:text-[#ededed]")}>{token.name}</span>
                                        </div>
                                  ...
                                  {isAlreadyAssigned && assignedNode && (
                                    <Tip label="Navigate to assigned node" side="left">
                                      ...
                                      >
                                        <Target className="h-3.5 w-3.5 text-[#465BFE]" />
                                      </button>
                                    </Tip>
                                  )}
                                  {isAlreadyAssigned && assignedNode && !isCurrentlyAssigned && isReassignPopoverOpen && (
                                    <Popover open={isReassignPopoverOpen} onOpenChange={(open) => {
                                      ...
                                      <PopoverContent 
                                        className="w-72 border-[#252525] p-0 shadow-[0_8px_30px_rgba(0,0,0,0.5)]" 
                                      ...
                                      >
                                        <div className="p-1.5">
                                          ...
                                          >
                                            <Link2 className="h-4 w-4 text-[#465BFE] shrink-0" />
                                            <span>Reassign to this node</span>
                                          </button>
                                        </div>
                                        <div className="px-4 pb-3 pt-1 text-xs">
                                          <p className="text-[#777] mb-2 leading-relaxed">
                                ...
                                >
                                  ...
                                  >
                                      <div className={cn(
                                        ...
                                        <div
                                          className={cn("w-3.5 h-3.5 rounded-[3px] shrink-0", (!isAssignedToAnyNode || _isEmpty2) && "border border-dashed border-[#252525]/40 opacity-40")}
    ...
    {(isSelected || activeAdvancedChannels.length > 0) && !isPaletteShade && (isPrimaryTheme || !isColorInherited) && (
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-[14px] text-[#555] select-none">Advanced</span>
        ...
        <button
          className="text-[#555] hover:text-[#999] cursor-pointer transition-colors p-0.5 rounded hover:bg-white/[0.04]"
          onClick={(e) => {
            e.stopPropagation();
    ...
    >
      <AlertDialogContent className="bg-[#111111] border-[#222] max-w-[400px]">
          ...
          <AlertDialogDescription asChild>
            <div className="text-[#a1a1a1] space-y-3">
              ...
              <div className="text-[12px] text-[#888]">
                This token was auto-assigned to node <span className="text-[#ccc]">{node.referenceName || node.id.slice(0, 8)}</span>.
                It may be recreated if the parent node&apos;s auto-assign is re-applied.
              </div>
              <label className="flex items-start gap-2.5 cursor-pointer group bg-[#1a1a1a] rounded-lg px-3 py-2.5 border border-[#1a1a1a] hover:bg-[#1a1a1a] transition-colors">
                <div
        ...
        <AlertDialogFooter>
          <AlertDialogCancel className="bg-[#1a1a1a] border-[#1a1a1a] text-[#ededed] hover:bg-[#222]">
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
