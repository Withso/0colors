    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-3">
          ...
          <button
            onClick={onClose}
            className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-[#252525] text-[#666] hover:text-white transition-colors cursor-pointer"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        {checking ? (
          ...
          <div className="px-6 pb-6">
            ...
            <div className="flex items-center gap-2">
                  ...
                  {showUnpublishConfirm ? (
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="h-9 px-3 rounded-lg text-[12px] text-[#666] hover:text-[#aaa] transition-colors cursor-pointer"
                      >
                        Cancel
                      </button>
                    </div>
              ...
              <button
                onClick={onClose}
                className="h-9 px-4 rounded-lg text-[12px] text-[#888] hover:text-white transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
