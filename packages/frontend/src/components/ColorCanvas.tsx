...
import { TokenNodeCard } from './TokenNodeCard';
    ...
    >
      ...
      <div className="group/nodelabel flex-1 min-w-0 flex items-center gap-0">
        ...
        {onDragMouseDown && !isEditing && fullName && (
          <div
            className="cursor-move opacity-0 group-hover/nodelabel:opacity-100 text-[#555] hover:!text-[#ededed] transition-all shrink-0 -ml-2"
            onMouseDown={(e) => {
              e.stopPropagation();
              onDragMouseDown(e);
            }}
