    ...
    <button
      ...
      className={`px-2 py-[3px] rounded text-[10px] transition-all duration-100 border ${
        active
          ...
          : 'bg-transparent text-[#666] border-[#ffffff]/[0.06] hover:text-[#999] hover:border-[#ffffff]/[0.1] hover:bg-[#ffffff]/[0.02]'
      }`}
    >
      {label}
    </button>
  ...
  return (
    <div ref={containerRef}>
      ...
      <div className="relative">
        <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3 w-3 text-[#555] pointer-events-none" />
        <input
          ref={inputRef}
          type="text"
        ...
        <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-1">
          ...
          {(searchQuery || hasFilters) && (
            <button
              ...
              className="text-[#555] hover:text-[#888] p-0.5"
            >
              <X className="h-3 w-3" />
            </button>
          )}
          {!searchQuery && !hasFilters && (
            <button
              ...
              className="text-[#444] hover:text-[#666] p-0.5"
            >
      ...
      {isExpanded && (
        <div className="mt-1.5 bg-[#0a0a0a] border border-[#ffffff]/[0.06] rounded-lg overflow-hidden">
          <div className="p-2 space-y-2">

            {/* Color Space Row */}
            <div>
              <div className="text-[9px] text-[#555] uppercase tracking-wider mb-1">Color Space</div>
            ...
            {/* Status Filters */}
            <div>
              <div className="text-[9px] text-[#555] uppercase tracking-wider mb-1">Status</div>
              <div className="flex flex-wrap gap-1">
            ...
            {!isPrimaryTheme && (
              <>
                <div className="h-px bg-[#ffffff]/[0.04]" />
                <div>
                  <div className="text-[9px] text-[#555] uppercase tracking-wider mb-1">Theme</div>
                  <div className="flex flex-wrap gap-1">
            ...
            <div className="h-px bg-[#ffffff]/[0.04]" />
            <div>
              <div className="text-[9px] text-[#555] uppercase tracking-wider mb-1">Palette</div>
              <div className="flex flex-wrap gap-1">
            ...
            <div className="text-[9px] text-[#444] leading-relaxed">
              ...
              Type <span className="text-[#555] font-mono">#hex</span> for color,{' '}
              <span className="text-[#555] font-mono">red</span>{' '}
              <span className="text-[#555] font-mono">blue</span>{' '}etc. for color names
            </div>
          </div>
          ...
          {hasFilters && (
            <div className="flex items-center justify-between px-2 py-1.5 bg-[#080808] border-t border-[#ffffff]/[0.04]">
              <span className="text-[10px] text-[#555]">{activeFilterCount} filter{activeFilterCount > 1 ? 's' : ''}</span>
              <button
                onClick={clearAll}
