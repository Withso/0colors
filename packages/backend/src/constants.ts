...
// Auth endpoints get a stricter limit: 5 attempts per 15 minutes per IP+identifier.
// Tight enough to slow online password guessing, loose enough that a user fat-
// fingering their password a few times in a row doesn't lock themselves out.
